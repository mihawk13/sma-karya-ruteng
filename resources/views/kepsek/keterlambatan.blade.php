...
<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
    <h5 class="txt-dark">Laporan Keterlambatan</h5>
</div>
<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
    <ol class="breadcrumb">
        <li><a href="/">Kepala Sekolah</a></li>
        <li class="active"><span>Laporan Keterlambatan</span></li>
    </ol>
</div>
@endsection
@section('content')
            ...
            <div class="panel-heading">
                <form method="POST" class="panel-body">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        @if ($thn != 0)
                        <a target="_blank" href="{{ route('kepsek.keterlambatan.cetak', [$thn, $prd]) }}" class="btn btn-danger">Cetak</a>
                        @endif
                    </div>
                </form>
            </div>
